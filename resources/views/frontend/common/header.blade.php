            ...
            <div class="row clearfix align-items-center">
                <div class="col-lg-3 col-md-9 col-sm-6">
                    <div class="brand-logo text-lg-center">
                        <a href="index.html">
                        <img src="{{ asset('frontend/images/main-logo/stack-developers-logo.png') }}" alt="Stack Developers" class="app-brand-logo">
                        </a>
                    </div>
                </div>
                    ...
                    <nav>
                        <ul class="mid-nav g-nav">
                            ...
                            <li>
                                ...
                                <span class="item-counter">444</span>
        ...
        <div class="mini-cart">
            ...
            <ul class="mini-cart-list">
                <li class="clearfix">
                    ...
                    <img src="{{ asset('frontend/images/product/product@1x.jpg') }}" alt="Product">
